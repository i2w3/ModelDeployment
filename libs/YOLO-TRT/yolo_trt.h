...
// 五种模型的参数配置
const ModelParams clsParams  = {224, 1000, cls_classes, 0.0f, 0.0f, 5, 0.0f, 0, 0.0f};
const ModelParams detParams  = {640, 80, det_classes, 0.25f, 0.45f, 300, 0.0f, 0, 0.0f};
const ModelParams obbParams  = {1024, 15, obb_classes, 0.25f, 0.45f, 300, 0.0f, 0, 0.0f};
const ModelParams poseParams = {640, 1, pose_classes, 0.25f, 0.45f, 300, 0.0f, 17, 0.5f};
const ModelParams segParams  = {640, 80, seg_classes, 0.25f, 0.45f, 300, 0.5f, 0, 0.0f};
#endif // YOLOTRT_H